        ...
        <section id="nosotros" className="py-20 px-6">
            <div className="container mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <img 
                            alt="Equipo de la Cooperativa *Empresa* trabajando juntos"
                    ...
                    >
                        <div>
                            ...
                            <p className="text-xl text-gray-300 leading-relaxed mb-6">
                                La Cooperativa *EMPRESA* nació del deseo de fortalecer el bienestar financiero de nuestros socios. Somos una familia que se apoya mutuamente para alcanzar grandes metas.
                            </p>
